...
namespace Reversi
{
    ...
    public class Reversi
    {
        ...
        private bool IsEnemyColor(int x, int y, Color color)
            => board.GetColor(x, y) == global::Reversi.Util.EnemyColor(color);
        ...
        public void SetColor(int x, int y, Color color)
        {
            ...
            if (board.GetColor(x, y) != Color.None) throw new OverlapStone();
